...
def klikwa():
 ...
 if json.loads(tes.text)["message"] == 'OTP Sent':
  ...
  print "     %s[%s%s%s] [%s Failed %s] %sFailed, spam %s from %s%s %snot sended %s>> %sMau yang unlimited? %shttps://github.com/Mr-S4NTUY/SpamWa
"%(pu,ku,"10",pu,me,pu,pu,"wa",ku,"klikwa",me,qu,pu,ku)
def bakmikeraton():
